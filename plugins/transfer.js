...
let handler = async (m, { itsu, args, usedPrefix, DevMode }) => {
    if (args.length < 3) {
        return itsu.reply(m.chat, `Gunakan format ${usedPrefix}transfer <type> <jumlah> <@tag>\ncontoh penggunaan: *${usedPrefix}transfer money 100 @tag*`.trim(), m)
    } else try {
            ...
            case 'money':
                if (global.DATABASE._data.users[m.sender].money >= count * 1) {
                    try {
                        ...
                        itsu.reply(m.chat, `Berhasil mentransfer money sebesar ${count}`.trim(), m)
                    } catch (e) {
                        global.DATABASE._data.users[m.sender].money += count * 1
                        ...
                        if (DevMode) {
                            for (let jid of global.owner.map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').filter(v => v != itsu.user.jid)) {
                                itsu.sendMessage(jid, 'Transfer.js error\nNo: *' + m.sender.split`@`[0] + '*\nCommand: *' + m.text + '*\n\n*' + e + '*', MessageType.text)
                            }
                        }
                    }
                } else itsu.reply(m.chat, `Uang kamu tidak mencukupi untuk mentransfer Money sebesar ${count}`.trim(), m)
                break
            case 'potion':
                if (global.DATABASE._data.users[m.sender].potion >= count * 1) {
                    try {
                        ...
                        itsu.reply(m.chat, `Berhasil mentransfer ${count} Potion`.trim(), m)
                    } catch (e) {
                        global.DATABASE._data.users[m.sender].potion += count * 1
                        m.reply('Gagal Menstransfer')
                        console.log(e)
                ...
                } else itsu.reply(m.chat, `Potion kamu tidak cukup`.trim(), m)
                break
            case 'sampah':
                if (global.DATABASE._data.users[m.sender].sampah >= count * 1) {
                    try {
                        ...
                        itsu.reply(m.chat, `Berhasil mentransfer ${count} Sampah`.trim(), m)
                    } catch (e) {
                        global.DATABASE._data.users[m.sender].sampah += count * 1
                        m.reply('Gagal Menstransfer')
                        console.log(e)
                ...
                } else itsu.reply(m.chat, `Sampah kamu tidak cukup`.trim(), m)
                break
            case 'diamond':
                if (global.DATABASE._data.users[m.sender].diamond >= count * 1) {
                    try {
                        ...
                        itsu.reply(m.chat, `Berhasil mentransfer ${count} Diamond`.trim(), m)
                    } catch (e) {
                        global.DATABASE._data.users[m.sender].diamond += count * 1
                        m.reply('Gagal Menstransfer')
                        console.log(e)
                ...
                } else itsu.reply(m.chat, `Diamond kamu kamu tidak cukup`.trim(), m)
                break
            case 'common':
                if (global.DATABASE._data.users[m.sender].common >= count * 1) {
                    try {
                        ...
                        itsu.reply(m.chat, `Berhasil mentransfer ${count} Common Crate`.trim(), m)
                    } catch (e) {
                        global.DATABASE._data.users[m.sender].common += count * 1
                        m.reply('Gagal Menstransfer')
                        console.log(e)
                ...
                } else itsu.reply(m.chat, `Common crate kamu kamu tidak cukup`.trim(), m)
                break
            case 'uncommon':
                if (global.DATABASE._data.users[m.sender].uncommon >= count * 1) {
                    try {
                        ...
                        itsu.reply(m.chat, `Berhasil mentransfer ${count} Uncommon Crate`.trim(), m)
                    } catch (e) {
                        global.DATABASE._data.users[m.sender].uncommon += count * 1
                        m.reply('Gagal Menstransfer')
                        console.log(e)
                ...
                } else itsu.reply(m.chat, `Uncommon crate kamu kamu tidak cukup`.trim(), m)
                break
            case 'mythic':
                if (global.DATABASE._data.users[m.sender].mythic >= count * 1) {
                    try {
                        ...
                        itsu.reply(m.chat, `Berhasil mentransfer ${count} Mythic crate`.trim(), m)
                    } catch (e) {
                        global.DATABASE._data.users[m.sender].mythic += count * 1
                        m.reply('Gagal Menstransfer')
                        console.log(e)
                ...
                } else itsu.reply(m.chat, `Mythic crate kamu kamu tidak cukup`.trim(), m)
                break
            case 'legendary':
                if (global.DATABASE._data.users[m.sender].legendary >= count * 1) {
                    try {
                        ...
                        itsu.reply(m.chat, `Berhasil mentransfer ${count} Legendary crate`.trim(), m)
                    } catch (e) {
                        global.DATABASE._data.users[m.sender].legendary += count * 1
                        m.reply('Gagal Menstransfer')
                        console.log(e)
                ...
                } else itsu.reply(m.chat, `Legendary crate kamu kamu tidak cukup`.trim(), m)
                break
case 'pandora':
                if (global.DATABASE._data.users[m.sender].pandora >= count * 1) {
                    try {
                        global.DATABASE._data.users[m.sender].pandora -= count * 1
                        global.DATABASE._data.users[who].pandora += count * 1
                        itsu.reply(m.chat, `Berhasil mentransfer ${count} Pandora crate`.trim(), m)
                    } catch (e) {
                        global.DATABASE._data.users[m.sender].pandora += count * 1
                        m.reply('Gagal Menstransfer')
                        console.log(e)
